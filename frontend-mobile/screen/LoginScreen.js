  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.loginBtn}>
        <Button color='#ffa366' title="Login" onPress={() => navigation.navigate("Tabs")} />
      </View>
      <TouchableOpacity style={{ marginTop: 30 }}>
        <Text title="Switch to Register" onPress={() => navigation.navigate("Register")}>Don't have an account? Switch to Register</Text>
      </TouchableOpacity>
